# SDD / Design Doc -- ManosAbiertas
Fecha: 2026-09-25 | Estado: Draft

## Arquitectura general

Stack: Node.js, Next.js, React, Tailwind, TypeScript. Estructura de primer nivel detectada:
...
CI: build.yml, ci.yml, deploy.yml, tutor-ia.yml.
