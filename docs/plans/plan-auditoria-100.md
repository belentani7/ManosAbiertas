# Plan -- Auditoria y documentacion al 100% (ManosAbiertas)
...
- [x] `docs/prd/prd-manosabiertas.md`.
- [x] `docs/srs/srs-manosabiertas.md`.
- [x] `docs/design/design-manosabiertas.md`.
