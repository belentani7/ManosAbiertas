# AGENTS.md -- ManosAbiertas

Reglas para agentes y personas que trabajen en este repositorio.

## Proposito del proyecto

Plataforma educativa gratuita: cursos IA/Office, creador CV, gu├¡as derechos y recursos para migrantes y comunidades.

Stack detectado: Node.js, Next.js, React, Tailwind, TypeScript.
